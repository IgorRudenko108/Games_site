(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-1__slider")) new swiper_core_Swiper(".slider-1__slider", {
            observer: true,
            slidesPerView: 1.9,
            spaceBetween: 20,
            observeParents: true,
        ...
        if (document.querySelector(".slider-2__slider")) new swiper_core_Swiper(".slider-2__slider", {
            observer: true,
            observeParents: true,
            slidesPerView: 1.9,
            spaceBetween: 20,
